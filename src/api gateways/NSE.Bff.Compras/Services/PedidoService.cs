...
namespace NSE.Bff.Compras.Services
{
    ...
    public class PedidoService : Service, IPedidoService
    {
        ...
        {
            var pedidoContent = SerializarObjetoParaJson(pedido);
        ...
        public async Task<IEnumerable<PedidoDTO>> ObterListaPorClienteId()
        {
            ...
            return await DeserializarJsonParaObjeto<IEnumerable<PedidoDTO>>(response);
        }
        ...
        public async Task<PedidoDTO> ObterUltimoPedido()
        {
            ...
            return await DeserializarJsonParaObjeto<PedidoDTO>(response);
        }
        ...
        public async Task<VoucherDTO> ObterVoucherPorCodigo(string codigo)
        {
            ...
            return await DeserializarJsonParaObjeto<VoucherDTO>(response);
        }
    }
}